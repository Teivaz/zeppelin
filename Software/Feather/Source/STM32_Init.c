...
#include "CMSIS/stm32f10x.h"                        // STM32F10x Library Definitions 
#include "CMSIS/STM32_Reg.h"                            // missing bit definitions
#include "CMSIS/stm32f10x_nvic.h"                            // missing bit definitions
...
#define __RCC_CFGR_VAL             0x001C8402
...
#define __TIM1_PERIOD             0x04E20                 //  4
#define __TIM1_PSC                0x0000                  //  5
#define __TIM1_ARR                0x0004                  //  6
#define __TIM1_RCR                0x0001                  //  7
