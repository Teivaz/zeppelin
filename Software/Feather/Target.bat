...
"C:\Keil\ARM\ARMCC\bin\ArmLink" --Via ".\UVisionOutput\Feather.lnp"
C:\Keil\ARM\ARMCC\bin\fromelf.exe ".\UVisionOutput\Feather.axf" --i32combined --output ".\UVisionOutput\Feather.hex"
fromelf --bin --output UVisionOutput/Feather.bin UVisionOutput/Feather.axf
