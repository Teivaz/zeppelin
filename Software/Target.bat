...
"C:\Keil\ARM\ARMCC\bin\ArmLink" --Via ".\UVisionOutput\ZepelinTranssmitter1.lnp"
C:\Keil\ARM\ARMCC\bin\fromelf.exe ".\UVisionOutput\ZepelinTranssmitter1.axf" --i32combined --output ".\UVisionOutput\ZepelinTranssmitter1.hex"
fromelf --bin --output UVisionOutput/ZepelinTranssmitter1.bin UVisionOutput/ZepelinTranssmitter1.axf
